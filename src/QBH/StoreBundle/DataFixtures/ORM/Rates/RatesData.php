...
namespace QBH\StoreBundle\DataFixtures\ORM\Rates;
...
class RatesData extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $dollarToEuroRate
            ->setSourceCurrency($currencyEuro)
            ->setTargetCurrency($currencyDollar)
            ->setExchangeRate(1.134781);
