...
namespace QBH\StoreBundle\DataFixtures\ORM\Product;
...
//        $filesystem = $this->container->get('gaufrette.product_image_fs_filesystem');
        ...
        $product
            ...
            ->setReducedPrice(Money::create(599, $currency))
            ->setEnabled(true);
    ...
    {
        return [
            'QBH\StoreBundle\DataFixtures\ORM\Currency\CurrencyData',
            'QBH\StoreBundle\DataFixtures\ORM\Category\CategoryData',
            'QBH\StoreBundle\DataFixtures\ORM\Attribute\AttributeData',
        ];
    }
}
